...
- 系统管理：提供用户账号的创建和管理、基于角色的角色和权限创建和管理、教研室的创建和管理功能，还提供了注册账号的账号审查功能，新注册的账号需要管理员手动启用。
- 流程管理：提供审批流程的定义和word模版管理相关的功能。
- 任务管理：提供审批任务的发起、审批、word导出等功能。
- 教学管理：提供教师的听课计划和辅导答疑记录功能。
- 毕业达成：提供课程专业、班级和各专业考核内容的创建和管理功能，同时也提供了毕业达成度各个指标的配置功能。
- 动态表单：提供审批流程的模块化表单创建和配置功能。
