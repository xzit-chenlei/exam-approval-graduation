...
(
    ...
    `is_valid`    int(11)      DEFAULT '0' COMMENT '逻辑删除',
    `remark`      varchar(255) DEFAULT NULL COMMENT '备注',
    `oss_key`     varchar(255) DEFAULT NULL COMMENT '对象存储的key',
    `url`         varchar(2048) DEFAULT NULL COMMENT '文件url',
    `scene_name`  varchar(255) DEFAULT NULL COMMENT '场景名称。可以用类名或者函数名代替',
    `obj_id`      int(11)      DEFAULT NULL COMMENT '关联外键',
    `short_link`  varchar(255) DEFAULT NULL COMMENT '短链(盐值)',
    PRIMARY KEY (`id`)
) ENGINE = InnoDB
