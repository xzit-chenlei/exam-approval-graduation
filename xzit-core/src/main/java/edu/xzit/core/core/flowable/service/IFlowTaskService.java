...
public interface IFlowTaskService {
     ...
     * @return
     */
    AjaxResult updateProcessVariables(String taskId, Map<String, Object> variables);

    /**
     * 已完成流程修改课题组/教研室（高危）
     */
    AjaxResult updateFinishedDept(Map<String, Object> body);
     ...
     * @return
     */
    AjaxResult allProcess(FlowQueryVo queryVo);
     ...
     * @return
     */
    AjaxResult generateWord(String procInsId);
     ...
     * @return
     */
    void generateWordNew(HttpServletResponse response,String procInsId);
}
