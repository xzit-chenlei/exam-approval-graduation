...
import edu.xzit.core.core.common.utils.uuid.IdUtils;
    ...
    public LoginUser getLoginUser(HttpServletRequest request) {
        ...
        if (StringUtils.isNotEmpty(token)) {
            try {
                ...
                Object result = redisCache.getCacheObject(userKey);

                // 由于fastjson的一个bug，这里需要判断一下
                if (result instanceof JSONObject){
                    return JSON.toJavaObject(result, LoginUser.class);
                }
