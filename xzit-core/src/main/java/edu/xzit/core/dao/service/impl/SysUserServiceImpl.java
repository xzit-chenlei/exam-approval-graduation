...
import edu.xzit.core.core.common.annotation.DataScope;
...
import edu.xzit.core.core.common.utils.bean.BeanValidators;
import edu.xzit.core.core.common.utils.spring.SpringUtils;
import edu.xzit.core.dao.domain.SysPost;
...
import edu.xzit.core.dao.mapper.*;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper,SysUser> implements ISysUserService {
    ...
    @Override
    public List<SysUser> selectUserListInfo(SysUser user) {
        LambdaQueryWrapper<SysUser> queryWrapper = new LambdaQueryWrapper<>(user);
    ...
    public boolean registerUser(SysUser user) {
        ...
        if (success && user.getDeptIds() != null && user.getDeptIds().length > 0) {
            insertUserDept(user.getUserId(), user.getDeptIds());
        }
        return success;
    }
